...
constexpr std::size_t pSenderNameList_SIZE = 55;
...
constexpr std::size_t pHistoryStrings_SIZE = 80;
constexpr std::size_t pLaptopIcons_SIZE = 8;
constexpr std::size_t pBookMarkStrings_SIZE = 12;
constexpr std::size_t pDownloadString_SIZE = 2;
constexpr std::size_t gsAtmStartButtonText_SIZE = 3;
constexpr std::size_t pWebPagesTitles_SIZE = 38;
...
constexpr std::size_t zOptionsToggleText_SIZE = 23;
...
constexpr std::size_t gzLaptopHelpText_SIZE = 20;
...
constexpr std::size_t zOptionsScreenHelpText_SIZE = 23;
